...
public class Jeopardy implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == firstButton) {
			...
			askQuestion("What is the largest desert on Earth?", "Antarctica", 200);
		...
		if (e.getSource() == secondButton) {
			// Call the askQuestion() method
			askQuestion("What is the largest mammal on Earth?", "The Blue Whale", 400);
		...
		if (e.getSource() == thirdButton) {
			// Call the askQuestion() method
			askQuestion("Which Country has the most active volcanoes?", "Indonesia", 600);
			thirdButton.setText(null);
		}
		if (e.getSource() == fourthButton) {
			// Call the askQuestion() method
			askQuestion("What year was the first cellphone invented?", "1973", 800);
			fourthButton.setText(null);
		}
		if (e.getSource() == fifthButton) {
			// Call the askQuestion() method
			askQuestion("What does the acronym URL stand for?", "Uniform Resource Locator", 1000);
